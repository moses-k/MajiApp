...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter. MessagesVieholder>
{
    ...
    private DatabaseReference usersDatabaseRef, technicianDatabaseRef;
    ...
    public MessagesVieholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new MessagesVieholder(v);
    }


    @Override
    public void onBindViewHolder(@NonNull final MessagesVieholder holder, int position)
    {
        ...
        technicianDatabaseRef = FirebaseDatabase.getInstance().getReference().child("technicians").child(fromUserID);
        ...
        usersDatabaseRef.addValueEventListener(new ValueEventListener()
        {
            ...
            public    void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    Picasso.get().load(image).placeholder(R.drawable.profile_image).into(holder.receiverProfileimge);
                }
            }
        ...
        if(fromMessageType.equals("text"));
        {
            ...
            if(fromUserID.equals(messageSenderID))
            {
                ...
                holder.SenderMessageText.setBackgroundResource(R.drawable.sender_message_textbackground);
